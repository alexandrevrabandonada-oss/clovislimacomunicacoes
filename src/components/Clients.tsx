...
export default function Clients() {
  ...
  return (
    <div>
      ...
      <p className="mt-3 text-sm md:text-base">Trabalhos publicados e realizados para:</p>
      ...
      <div className="mt-6 flex justify-center">
        <p className="inline-block rounded-full bg-slate-100 px-4 py-2 text-sm font-medium text-slate-700">
          Cases e resultados detalhados disponíveis sob solicitação.
        </p>
      </div>
    </div>
  )
