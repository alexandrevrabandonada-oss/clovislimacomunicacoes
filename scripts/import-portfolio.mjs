...
async function main() {
  ...
  for (const absPath of files) {
    ...
    const upsertPayload = {
      ...
      slug,
      type: dbType,
      subtitle: manifestItem.subtitle || null,
      client: manifestItem.client || null,
      vehicle: manifestItem.vehicle || null,
      year: manifestItem.year || (new Date()).getFullYear(),
      tags: Array.isArray(manifestItem.tags) ? manifestItem.tags : [],
      available_for_print: !!manifestItem.available_for_print,
      available_for_license: !!manifestItem.available_for_license,
      featured: !!manifestItem.featured,
      cover_url: publicUrl,
